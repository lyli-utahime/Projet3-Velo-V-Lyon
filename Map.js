...
//console.log(station);
	...
	infoStation(station) {
		...
		let stationData = station.target.options.station;   
        ...
        document.getElementById("station-status").innerText = stationData.status;
        document.getElementById("form_book").style.visibility = "hidden";
        if (stationData.status === "OPEN" && stationData.available_bikes >= 1) {
            document.getElementById("form_book").style.visibility = "visible";
        }

        
        this.reservation = document.getElementById("form_book");
